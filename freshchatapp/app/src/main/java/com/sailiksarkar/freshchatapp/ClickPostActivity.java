...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PostImage = (RoundedImageView) findViewById(R.id.Post_image_before_edit);
        PostDescription = (TextView) findViewById(R.id.click_post_descriptions);
        ...
        ClickPostRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot)
            {
                if (snapshot.exists())
                {
                    description = snapshot.child("desctiption").getValue().toString();
...

    {
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            {
                ClickPostRef.child("desctiption").setValue(inputField.getText().toString());
